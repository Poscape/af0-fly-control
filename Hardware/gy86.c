...
{
    uint16_t data = 0;
    data = (uint16_t)(I2C1_Read_7bitmode_Register(MPU6050_ADDR, MPU6050_GYRO_XOUT_H) << 8) + I2C1_Read_7bitmode_Register(MPU6050_ADDR, MPU6050_GYRO_XOUT_L);
    return data;
}
...
{
    uint16_t data = 0;
    data = (uint16_t)(I2C1_Read_7bitmode_Register(MPU6050_ADDR, MPU6050_GYRO_YOUT_H) << 8) + I2C1_Read_7bitmode_Register(MPU6050_ADDR, MPU6050_GYRO_YOUT_L);
    return data;
}
...
{
    uint16_t data = 0;
    data = (uint16_t)(I2C1_Read_7bitmode_Register(MPU6050_ADDR, MPU6050_GYRO_ZOUT_H) << 8) + I2C1_Read_7bitmode_Register(MPU6050_ADDR, MPU6050_GYRO_ZOUT_L);
    return data;
}
